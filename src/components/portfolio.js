...
const MobileOverlay = ({ isOpen, onClose }) => {
  ...
  const fileContents = {
    'welcome.md': "# Welcome to My Portfolio! 👋\n\nHi! I'm a passionate Software Engineer with expertise in full-stack development and AI/ML.\n\nThis portfolio is designed as an interactive IDE experience - feel free to explore each file to learn more about my journey and work!\n\n## 📁 File Structure\n\nportfolio-Final1111/\n├── 📋 projects.json       # Showcase of my open-source & enterprise projects\n├── 💼 experience.json     # Professional journey and accomplishments\n├── 🎓 education.json      # Academic background and achievements\n├── 🏆 certifications.json # Professional certifications and courses\n├── 📄 resume.pdf         # Downloadable resume\n└── ✉️ contact.py         # Get in touch with me!\n\n## 🚀 Quick Navigation Guide\n\n1. Projects (projects.json)\n   - Full-stack web applications\n   - AI/ML implementations\n   - Enterprise solutions\n   - Open-source contributions\n\n2. Experience (experience.json)\n   - Current and previous roles\n   - Key responsibilities\n   - Technical achievements\n   - Team collaborations\n\n3. Education (education.json)\n   - Degrees and specializations\n   - Academic achievements\n   - Relevant coursework\n\n4. Certifications (certifications.json)\n   - Technical certifications\n   - Industry-recognized credentials\n   - Specialized training\n\n5. Resume (resume.pdf)\n   - Detailed professional history\n   - Technical skills overview\n   - Project highlights\n\n6. Contact (contact.py)\n   - Send me a message\n   - Discuss potential collaborations\n   - Share exciting opportunities\n\n## 🔗 Quick Links\n   GitHub:   Find my open-source contributions\n   LinkedIn: Connect professionally\n   Twitter:  Follow my tech journey\n   Email:    Reach out directly\n\nFeel free to click through the files in the sidebar to learn more about each aspect\nof my professional journey. I've designed this portfolio to be interactive and\ninformative - enjoy exploring!\n\n---\nTip: Click on any file in the sidebar to view its contents. Start with projects.json\nto see my latest work, or head straight to contact.py if you'd like to get in touch!",
